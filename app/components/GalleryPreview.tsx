    ...
    <section className={`${playfair.variable} relative py-32 bg-black overflow-hidden perspective-1000`}>
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-extrabold text-white ff-playfair">
            Featured <span className="bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">Gallery</span>
          </h2>
