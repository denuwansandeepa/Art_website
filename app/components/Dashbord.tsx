...
export default function LatestUpdate() {
  ...
  return (
    <section className={`${playfair.variable} relative min-h-screen bg-[#050505] py-32 overflow-hidden perspective-1000`}>
      ...
      {/* Background Glow */}
      <div className="absolute top-1/2 right-0 w-125 h-125 bg-primary/10 rounded-full blur-[150px] pointer-events-none -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-125 h-125 bg-secondary/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="relative max-w-6xl mx-auto px-6 z-10">
        ...
        >
          {updates.map((update, index) => (
            ...
            >
              {/* Dot */}
              <div className="absolute -left-10.5 top-4 w-6 h-6 bg-primary rounded-full border-4 border-[#050505] shadow-[0_0_15px_rgba(157,78,221,0.8)] group-hover:bg-secondary group-hover:shadow-[0_0_20px_rgba(255,0,127,1)] transition-colors duration-300 z-10" />
