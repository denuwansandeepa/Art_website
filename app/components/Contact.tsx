...
export default function Contact() {
  ...
  return (
    <main
      className={`${playfair.variable} relative min-h-screen bg-[#020202] py-32 overflow-hidden perspective-1000`}
    >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            ...
            out through our contact details.
          </p>
        </motion.div>
